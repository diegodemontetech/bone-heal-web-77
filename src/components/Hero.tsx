      ...
      <div className="relative max-w-[1440px] mx-auto px-8 lg:px-24 py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="text-6xl lg:text-8xl font-bold mb-8 leading-[1.1] tracking-tight text-white font-heading">
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300"
              >
